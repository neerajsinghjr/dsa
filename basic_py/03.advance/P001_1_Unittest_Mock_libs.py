...
print("@before: ", dt.today.return_value)  
# OUTPUT:: @before: <Mock name='mock.today()' id='139762336560464'>

# Assign the return_value with tuesday for the mock object;;
dt.today.return_value = tuesday
# OUTPUT:: tuesday: 2019-01-01 00:00:00

print("@after: ", dt.today.return_value) 
# OUTPUT:: @after tuesday :  2019-01-01 00:00:00
