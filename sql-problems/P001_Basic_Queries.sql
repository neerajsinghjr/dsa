/*
----------------------------------------------------------------------------------------------------
-> Problem Title: Basic MySql Queries Bundle
-> Problem Status: Ongoing...
-> Problem Attempted: 14/10/2022
-> Problem Description: 
----------------------------------------------------------------------------------------------------
Table Details Here:
...
/* 
Q01: Query to retrieve the first four characters of  EmpLname from the
EmployeeInfo table
*/
...
/*
Q02: Query to fetch the EmpFname from the EmployeeInfo table in upper case
...
/* 
Q03: Query to fetch the number of employees working in the
department ‘HR’.
*/
SELECT COUNT(*) 
FROM EmployeeInfo 
...
/*
Q05: Query to fetch only the place name(string before brackets) from the
Address column like - (DEL), from EmployeeInfo table.
*/
...
/* Q06: Query to create a new table which consists of data and structure
...
/*
Q10: Query to retrieve the EmpFname and EmpLname in a single column
...
/*
Q11: Query find number of employees whose DOB is between 02/05/1970 to
...
/*
Q12: Query to fetch all the records from the EmployeeInfo table ordered by
...
/*
Q15: Query to fetch the department-wise count of employees sorted by
...
/* 
Q17: Query to retrieve employee details from EmployeeInfo table who have a
...
/* 
Q18: Query to retrieve two minimum and maximum salaries from the
...
/* 
Q19: Query to find the Nth highest salary from the table without using
TOP/limit keyword.
*/
SELECT Salary 
...
/* 
Q24: Query to display the first and the last record from the EmployeeInfo
table.
*/
--- Solution #1:
SELECT * 
...
/* 
Q26: Query to retrieve Departments who have less than 2 employees working in
it.
*/
...
/* 
Q27: Query to retrieve EmpPostion along with total salaries paid for each of
them.
*/
...
/* 
Q30: Query to display the total salary of each employee adding the Salary with
Variable value.
*/
SELECT EmpId,
...
/* 
Q31: Query to fetch the employees whose name begins with any two characters,
...
/* 
Q32: Query to fetch all the EmpIds which are present in either of the
